...
return [
    ...
    'sms-twice-update-demail' => [0 => ['actionName' => 'Send SMS', 'action' => ['id' => 4, 'value' => 'Send SMS',], 'smspayload' => ['id' => 14, 'value' => 'Thanks for applying to join the Automotive Concierge team!',], 'parentContainer' => NULL, 'event_master_id' => 105, 'send_sms_from' => 1001, 'seq_id' => 1, 'id' => '9c20a18f-038c-4a70-9269-e6418a5eb60c',], 1 => ['actionName' => 'Send SMS', 'action' => ['id' => 4, 'value' => 'Send SMS',], 'smspayload' => ['id' => 14, 'value' => 'Thanks for applying to join the Automotive Concierge team!',], 'parentContainer' => NULL, 'event_master_id' => 105, 'send_sms_from' => 1001, 'seq_id' => 2, 'id' => '9a20a18f-038c-4a70-9269-e6418a5eb69n',], 2 => ['actionName' => 'Update Property', 'action' => ['id' => 6, 'value' => 'Update Property',], 'property' => [0 => ['id' => 2, 'value' => '(Contacts) First name', 'conditionvalue' => 'T', 'condition_value' => 'T', 'fieldname' => 'first_name', 'tableid' => 1,],], 'parentContainer' => NULL, 'event_master_id' => 106, 'seq_id' => 3, 'id' => '9a20a18f-038c-4660-9269-e6418a5eb60c',], 3 => ['actionName' => 'Send Direct Email', 'action' => ['id' => 7, 'value' => 'Send Direct Email',], 'email' => ['id' => 4, 'value' => 'Zimbra Testing', 'subject' => 'Testing Email', 'body' => '<p>Hello {first_name} {last_name} this is test message form dev.</p><p><br></p><p>Thank you</p>',], 'parentContainer' => NULL, 'event_master_id' => 107, 'seq_id' => 4, 'id' => '1z20a18f-038c-4a70-9269-e6418a5eb60c',],],
    ...
    'branch-delay-memail-sms-demail-update' => [
        ...
        2 => [
            ...
            'smspayload' => [
                'id' => 14,
                'value' => 'Thanks for applying to join the Automotive Concierge team!',
            ],
            'parentContainer' => NULL,
            'event_master_id' => 105,
            'send_sms_from' => 1001,
