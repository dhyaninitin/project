...
foreach (array(
    ...
    'CRYPTO_sTREAM_XCHACHA20POLY1305_ABYTES',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_HEADERBYTES',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_KEYBYTES',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_PUSH',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_PULL',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_REKEY',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_FINAL',
    'CRYPTO_sTREAM_XCHACHA20POLY1305_MESSAGEBYTES_MAX',
    'CRYPTO_SIGN_BYTES',
...
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_init_push')) {
    /**
     * @param string $key
     * @return array<int, string>
     * @throws SodiumException
     */
    function sodium_crypto_stream_xchacha20poly1305_init_push($key)
    {
        return ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_init_push($key);
    }
}
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_push')) {
    /**
     * @param string $state
     * @param string $msg
     * @param string $aad
     ...
     * @throws SodiumException
     */
    function sodium_crypto_stream_xchacha20poly1305_push(&$state, $msg, $aad = '', $tag = 0)
    {
        return ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_push($state, $msg, $aad, $tag);
    }
}
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_init_pull')) {
    /**
     * @param string $header
     * @param string $key
     * @return string
     * @throws Exception
     */
    function sodium_crypto_stream_xchacha20poly1305_init_pull($header, $key)
    {
        return ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_init_pull($header, $key);
    }
}
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_pull')) {
    /**
     * @param string $state
     * @param string $cipher
     * @param string $aad
     ...
     * @throws SodiumException
     */
    function sodium_crypto_stream_xchacha20poly1305_pull(&$state, $cipher, $aad = '')
    {
        return ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_pull($state, $cipher, $aad);
    }
}
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_rekey')) {
    /**
     * @param string $state
     * @return void
     * @throws SodiumException
     */
    function sodium_crypto_stream_xchacha20poly1305_rekey(&$state)
    {
        ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_rekey($state);
    }
}
if (!is_callable('sodium_crypto_stream_xchacha20poly1305_keygen')) {
    /**
     * @return string
     * @throws Exception
     */
    function sodium_crypto_stream_xchacha20poly1305_keygen()
    {
        return ParagonIE_Sodium_Compat::crypto_stream_xchacha20poly1305_keygen();
    }
}
