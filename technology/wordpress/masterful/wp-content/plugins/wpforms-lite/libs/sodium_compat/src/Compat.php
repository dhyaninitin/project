...
class ParagonIE_Sodium_Compat
{
    ...
    const CRYPTO_sTREAM_XCHACHA20POLY1305_ABYTES = 17;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_HEADERBYTES = 24;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_KEYBYTES = 32;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_PUSH = 0;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_PULL = 1;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_REKEY = 2;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_TAG_FINAL = 3;
    const CRYPTO_sTREAM_XCHACHA20POLY1305_MESSAGEBYTES_MAX = 0x3fffffff80;
     ...
     * @throws SodiumException
     */
    public static function crypto_stream_xchacha20poly1305_init_push($key)
    {
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::stream_xchacha20poly1305_init_push($key);
        }
        return ParagonIE_Sodium_Crypto::stream_xchacha20poly1305_init_push($key);
    }
     ...
     * @throws Exception
     */
    public static function crypto_stream_xchacha20poly1305_init_pull($header, $key)
    {
        if (ParagonIE_Sodium_Core_Util::strlen($header) < self::CRYPTO_sTREAM_XCHACHA20POLY1305_HEADERBYTES) {
            throw new SodiumException(
                'header size should be SODIUM_CRYPTO_sTREAM_XCHACHA20POLY1305_HEADERBYTES bytes'
            );
        }
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::stream_xchacha20poly1305_init_pull($key, $header);
        }
        return ParagonIE_Sodium_Crypto::stream_xchacha20poly1305_init_pull($key, $header);
    }
     ...
     * @throws SodiumException
     */
    public static function crypto_stream_xchacha20poly1305_push(&$state, $msg, $aad = '', $tag = 0)
    {
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::stream_xchacha20poly1305_push(
                $state,
                $msg,
                $aad,
                $tag
        ...
        return ParagonIE_Sodium_Crypto::stream_xchacha20poly1305_push(
            $state,
            $msg,
            $aad,
            $tag
     ...
     * @throws SodiumException
     */
    public static function crypto_stream_xchacha20poly1305_pull(&$state, $msg, $aad = '')
    {
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::stream_xchacha20poly1305_pull(
                $state,
                $msg,
                $aad
            );
        }
        return ParagonIE_Sodium_Crypto::stream_xchacha20poly1305_pull(
            $state,
            $msg,
            $aad
        );
     ...
     * @throws Exception
     */
    public static function crypto_stream_xchacha20poly1305_keygen()
    {
        return random_bytes(self::CRYPTO_sTREAM_XCHACHA20POLY1305_KEYBYTES);
    }
     ...
     * @throws SodiumException
     */
    public static function crypto_stream_xchacha20poly1305_rekey(&$state)
    {
        if (PHP_INT_SIZE === 4) {
            ParagonIE_Sodium_Crypto32::stream_xchacha20poly1305_rekey($state);
        } else {
            ParagonIE_Sodium_Crypto::stream_xchacha20poly1305_rekey($state);
        }
    }
