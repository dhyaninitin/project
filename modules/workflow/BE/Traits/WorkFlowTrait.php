...
trait WorkFlowTrait
{
    ...
    protected function mailTemplateCollection($response){
    ...
    protected function emailAction($templateDetails, $userDetails, $workflowType, $triggerData, $workflowDetails = null, $actionId = null){
        ...
        $fromName = 'Carblip';
        $email = new Mail();
        $email->setTemplateId($templateDetails->id);
        ...
        foreach ($userDetails as $users) {
            ...
            $toName = $users->first_name . ' ' . $users->last_name;
            ...
            $email->addTo($toEmail, $toName, $substitutions);
